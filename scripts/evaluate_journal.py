...
def main():
    ...
    selected_checkpoint_status=require_complete_checkpoint(ck,exact_budget=False)
    completion_record=verify_run_completion_artifact(a.ckpt,ck)
