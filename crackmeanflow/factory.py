...
def build_model_and_rasterizer(cfg,device):
    ...
    from crackmeanflow.journal.models.shared_sit_flow import build_shared_crack_sit
    ...
    if bb=='sit_shared_mask': return build_shared_crack_sit(mcfg).to(device),None
...
def build_training_components(cfg,device):
    ...
    elif bb=='sit_shared_mask': loss=MatchedSiTFlowLoss(**cfg['loss'])
